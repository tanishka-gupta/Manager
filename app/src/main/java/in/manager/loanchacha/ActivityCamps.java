...
public class ActivityCamps extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterCamps tabPagerAdapter;
    private String[] tabs = { "प्रेषक" };
    @Override
...
*/
        ...
        tabPagerAdapter = new AdapterCamps(getSupportFragmentManager());
        ...
        actionBar.setTitle("Camps Meditation Workshops");
