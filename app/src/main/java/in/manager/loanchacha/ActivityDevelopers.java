...
public class ActivityDevelopers extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterDevelopers tabPagerAdapter;
...
*/
        ...
        tabPagerAdapter = new AdapterDevelopers(getSupportFragmentManager());
