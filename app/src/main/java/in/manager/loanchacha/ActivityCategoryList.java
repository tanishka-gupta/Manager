        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               // new getDataTask().execute();
                ...
                Intent iMenuList = new Intent(ActivityCategoryList.this, ActivityMenuBulk.class);
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                try {
                    if (IsLeaf.get(position).equals("1")) {
                        ...
                        Intent iMenuList = new Intent(ActivityCategoryList.this, ActivitySubCategoryList.class);
                    ...
                    Toast.makeText(ActivityCategoryList.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
			}
		});
