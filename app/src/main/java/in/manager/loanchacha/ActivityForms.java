...
public class ActivityForms extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterForms tabPagerAdapter;
...
*/
        ...
        tabPagerAdapter = new AdapterForms(getSupportFragmentManager());
        ...
        actionBar.setTitle("Commissions & Earnings");
