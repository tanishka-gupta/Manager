...
public class ActivityCrisis extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterCrisis tabPagerAdapter;
...
*/
        ...
        tabPagerAdapter = new AdapterCrisis(getSupportFragmentManager());
