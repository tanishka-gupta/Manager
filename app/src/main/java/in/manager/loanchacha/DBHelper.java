...
public class DBHelper extends SQLiteOpenHelper{
    ...
    private final String NOTI_TABLE_NAME = "tbl_noti";
    private final String NOTI_ID="id";
    private final String NOTI_MSG="msg";
    private final String NOTI_ONTIME="ontime";
    ...
    /** this code is used to get all notification from database */
    public ArrayList<ArrayList<Object>> getAllNotification(){
        ArrayList<ArrayList<Object>> dataArrays = new ArrayList<ArrayList<Object>>();
        ...
        try{
           // db.query()
            cursor = db.query(
                    ...
                    NOTI_TABLE_NAME,
                    new String[]{NOTI_ID, NOTI_MSG, NOTI_ONTIME},
                    null,null, null, null,NOTI_ID+" DESC");
    ...
    /** this code is used to get all notification from database */
    public boolean isNotificationExist(long id){
        boolean exist = false;
    ...
    public boolean isPreviousNotificationExist(){
        boolean exist = false;
    ...
    public void addNotification(String msg){
        // this is a key value pair holder used by android's SQLite functions
        ContentValues values = new ContentValues();
        values.put(NOTI_MSG, msg);

        // ask the database object to insert the new data
        try{db.insert(NOTI_TABLE_NAME, null, values);}
        catch(Exception e)
        {
            Log.e("DB ERROR", e.toString());
            e.printStackTrace();
    ...
    public void deleteNotification(long id){
        // ask the database manager to delete the row of given id
        try {db.delete(NOTI_TABLE_NAME, NOTI_ID + "=" + id, null);}
        catch (Exception e)
        {
            Log.e("DB ERROR", e.toString());
            e.printStackTrace();
    ...
    public void deleteAllNotification(){
        // ask the database manager to delete the row of given id
        try {db.delete(NOTI_TABLE_NAME, null, null);}
        catch (Exception e)
        {
            Log.e("DB ERROR", e.toString());
            e.printStackTrace();
    ...
    public void updateNotification(long id, String msg, String ontime){
        // this is a key value pair holder used by android's SQLite functions
        ContentValues values = new ContentValues();
        values.put(NOTI_MSG, msg);
        values.put(NOTI_ONTIME, ontime);

        // ask the database object to update the database row of given rowID
        try {db.update(NOTI_TABLE_NAME, values, NOTI_ID + "=" + id, null);}
        catch (Exception e)
        {
            Log.e("DB Error", e.toString());
            e.printStackTrace();
