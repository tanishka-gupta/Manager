...
public class ActivityFaq extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterFaq tabPagerAdapter;
...
*/
        ...
        tabPagerAdapter = new AdapterFaq(getSupportFragmentManager());
