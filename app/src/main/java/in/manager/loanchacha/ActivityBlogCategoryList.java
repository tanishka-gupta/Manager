...
public class ActivityBlogCategoryList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blogcategory_list);

        txtSlider = (WebView) findViewById(R.id.txtSlider);

        txtSlider.setVisibility(View.GONE);
        ...
        MenuAPI = Constant.BlogAPI+"?accesskey="+Constant.AccessKey+"&category_id=0";
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               // new getDataTask().execute();
                ...
                Intent iMenuList = new Intent(ActivityBlogCategoryList.this, ActivityMenuList.class);
        ...
        cla = new AdapterBlogCategoryList(ActivityBlogCategoryList.this);

        // category API url
    	CategoryAPI = Constant.BlogCategoryAPI+"?accesskey="+Constant.AccessKey;
...
*/
                     /*   Intent iMenuList = new Intent(ActivityBlogCategoryList.this, ActivitySubCategoryList.class);
                  ...
                  //  } else {
                        Intent iMenuList = new Intent(ActivityBlogCategoryList.this, ActivityBlogList.class);
                        iMenuList.putExtra("category_id", Category_ID.get(position));
                        iMenuList.putExtra("category_name", Category_name.get(position));
                        startActivity(iMenuList);
                        overridePendingTransition(R.anim.open_next, R.anim.close_next);
                   ...
                   // }
                    ...
                    Toast.makeText(ActivityBlogCategoryList.this,ex.toString(),Toast.LENGTH_LONG).show();
                }
			}
		});
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.cart:
			// refresh action
			Intent iMyOrder = new Intent(ActivityBlogCategoryList.this, ActivityCart.class);
