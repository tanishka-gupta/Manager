...
public class ActivityVideoGalleryCategoryList extends Activity {
    ...
    AdapterVideoGalleryCategoryList cla;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gallery_category_list);
        ...
        bar.setTitle("Choose Album");

        prgLoading = (ProgressBar) findViewById(R.id.prgLoading);
        listCategory = (GridView) findViewById(R.id.listCategory);
        txtAlert = (TextView) findViewById(R.id.txtAlert);

        cla = new AdapterVideoGalleryCategoryList(ActivityVideoGalleryCategoryList.this);

        // category API url
        CategoryAPI = Constant.VideoGalleryCategoryAPI+"?accesskey="+Constant.AccessKey;
        ...
        listCategory.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                // go to menu page
                Intent iMenuList = new Intent(ActivityVideoGalleryCategoryList.this, ActivityVideoGalleryList.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.cart:
                // refresh action
                Intent iMyOrder = new Intent(ActivityVideoGalleryCategoryList.this, ActivityCart.class);
