...
public class ActivityGalleryCategoryList extends Activity {
    ...
    AdapterGalleryCategoryList cla;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bar.setTitle("एलबम चुनें");

        prgLoading = (ProgressBar) findViewById(R.id.prgLoading);
        listCategory = (GridView) findViewById(R.id.listCategory);
        txtAlert = (TextView) findViewById(R.id.txtAlert);

        cla = new AdapterGalleryCategoryList(ActivityGalleryCategoryList.this);

        // category API url
        CategoryAPI = Constant.GalleryCategoryAPI+"?accesskey="+Constant.AccessKey;
        ...
        listCategory.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                // go to menu page
                Intent iMenuList = new Intent(ActivityGalleryCategoryList.this, ActivityGalleryList.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.cart:
                // refresh action
                Intent iMyOrder = new Intent(ActivityGalleryCategoryList.this, ActivityCart.class);
