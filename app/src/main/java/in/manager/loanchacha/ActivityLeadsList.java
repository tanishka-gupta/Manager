...
public class ActivityLeadsList extends Activity {
...
//        txtTitle.setText(Category_name);
        ...
        mla = new AdapterDownloadsList(ActivityLeadsList.this);
...
//                            Toast.makeText(ActivityDownloadsList.this,"File downloaded in your download folder",Toast.LENGTH_LONG).show();
                            ...
                            if(ContentResolver.SCHEME_FILE.equals(attachmentUri.getScheme())) {
                                ...
                                attachmentUri = FileProvider.getUriForFile(ActivityLeadsList.this,"in.manager.loanchacha.provider",file);
                            }
                            ...
                            if(is_download) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(ActivityLeadsList.this,"File downloaded in your download folder",Toast.LENGTH_LONG).show();
                                }
...
//        });
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast.makeText(ActivityLeadsList.this,"COMPLETED",Toast.LENGTH_LONG).show();
